<?php include '_PHP_Page_Includes/Include_Block_List.php' ?>

<!DOCTYPE html>
<html>
<head>
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" text="text/css" href="CSS/Block_List_CSS.css">
...
<body>
	...
	<div id="header_bar">
		<span>
			...
			<div>
				<div class="dropdown_notifications" style="position: relative; float:right; padding-left:75px;">
					<img class="dropimg" style="width:40px; margin-top:10px; margin-left:-100px;" src="http://localhost/Matcha/UI/Notification.png"/>
					<img class="dropimg" HIDDEN style="position:absolute; width:25px; top: 8px; left: 0px;" id="Notify-Img" src="http://localhost/Matcha/UI/Notification-Icon.png"/>
					<div style="margin-left:-235px;" class="dropdown_notifications-content" id="dropdown_notifications-content"></div>
				</div>
	...
	<script type="text/javascript" src="_JS_Page_Includes/JS_Block_List.js"></script>
</body>